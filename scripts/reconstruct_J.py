...
def main():
    ...
    print(f"  alpha_EM = 1 / (4 * pi * Omega / |alpha_D|)")

    alpha_em_derived = 1.0 / (4 * np.pi * 24 / abs(alpha_D_engine))
    print(f"  alpha_EM (derived) = {alpha_em_derived:.8f}")
    print(f"  1/alpha_EM = {1/alpha_em_derived:.4f}")
    print(f"  CODATA 2018: 1/alpha_EM = 137.035999084")
